 ...
 */
	public function input($fieldName, $options = array()) {
		...
		if ($options['type'] === 'datetime' || $options['type'] === 'date' || $options['type'] === 'time') {
			$dateFormat = $this->_extractOption('dateFormat', $options, 'YMD');
 ...
 */
	protected function _parseOptions($options) {
		$options = array_merge(
			array('before' => null, 'between' => null, 'after' => null, 'format' => null,'class'=>'form-control'),
			$this->_inputDefaults,
			$options
		);
 ...
 */
	public function button($title, $options = array()) {
		$options += array('type' => 'submit', 'escape' => false, 'secure' => false,'class'=>'btn brn-primary');
		if ($options['escape']) {
			$title = h($title);
		}
 ...
 */
	public function submit($caption = null, $options = array()) {
		...
		$options += array('type' => 'submit', 'before' => null, 'after' => null, 'secure' => false,'class'=>'btn btn-primary');
 ...
 */
	public function dateTime($fieldName, $dateFormat = 'DMY', $timeFormat = '12', $attributes = array()) {
		$attributes += array('empty' => true, 'value' => null,'class'=>'form-control-dateTime');
		...
		$keys = array('Year', 'Month', 'Day', 'Hour', 'Minute', 'Meridian');
		...
		switch ($name) {
			...
			case 'month':
				if ($options['monthNames'] === true) {
					...
					$data['08'] = __d('cake', '8月');
					$data['09'] = __d('cake', '9月');
					$data['10'] = __d('cake', '10月');
					$data['11'] = __d('cake', '11月');
					$data['12'] = __d('cake', '12月');
